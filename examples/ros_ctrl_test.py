...
def main(args=None):
    ...
    #MODELDIR = os.path.join(DIR, 'models', 'blimpNarrowSensor-Cameron.ttm')
    MODELDIR = os.path.join(DIR, 'models', 'blimp_narrow.ttm')
    ...
    f = 1.
    i = 0
    while (not RECCY) and (i < 5):  # either permanently run, or record a few positions
        i += 1
